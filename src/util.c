...
int
read_conf(char *filename, conf_val *cv, char *buf, int len)
{
...
make_hash_func1(char *name, unsigned int len)
{
    unsigned int h, k;
...
static inline unsigned long
make_hash_func2(char *key, uint len)
{
